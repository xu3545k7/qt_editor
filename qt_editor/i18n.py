...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    'zh_tw': {
        ...
        'action_save_xml_midi_restore': '依 MIDI 音高還原為 XML…',
        'action_quit':          '離開(&Q)',
        ...
        'dlg_save_xml_midi_restore_title': '依 MIDI 音高還原為 XML',
    ...
    'zh_cn': {
        ...
        'action_save_xml_midi_restore': '按 MIDI 音高还原为 XML…',
        'action_quit':          '退出(&Q)',
        ...
        'dlg_save_xml_midi_restore_title': '按 MIDI 音高还原为 XML',
    ...
    'en': {
        ...
        'action_save_xml_midi_restore': 'Restore XML from MIDI Pitch…',
        'action_quit':          'Quit(&Q)',
        ...
        'dlg_save_xml_midi_restore_title': 'Restore XML from MIDI Pitch',
